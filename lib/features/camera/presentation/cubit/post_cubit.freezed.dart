...
mixin _$PostState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String name, String file) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String name, String file)? success,
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(this.name, this.file);
  ...
  @override
  String toString() {
    return 'PostState.success(name: $name, file: $file)';
  }
...
abstract class _Success implements PostState {
  const factory _Success(final String name, final String file) = _$SuccessImpl;
